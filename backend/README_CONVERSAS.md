...
- A KB é carregada automaticamente a partir do primeiro diretório existente na ordem: `backend-fastapi/know_base`, `backend-fastapi/kb`, `./know_base`, `./kb`.
- Se `KB_DIR` estiver definida no ambiente do serviço, ela tem prioridade sobre os caminhos acima.
- O repositório inclui `backend-fastapi/know_base` com 3 leis estruturadas (Lei 7.716/1989, Lei 12.288/2010 e Lei 14.532/2023) que são priorizadas no RAG e sempre consideradas junto com os top‑k documentos por palavras‑chave.
